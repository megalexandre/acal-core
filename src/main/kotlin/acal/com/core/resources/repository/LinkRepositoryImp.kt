...
import acal.com.core.resources.LinkModel
import acal.com.core.resources.repository.query.LinkQuery
...
class LinkRepositoryImp(
    ...
    override fun findActive(): Collection<Link> {
        return linkRepository.findByActiveTrue().map { it.toDomain() }
    }
...
interface LinkRepository: MongoRepository<LinkModel, String>{
    ...
    fun findByActiveTrue(): Collection<LinkModel>
