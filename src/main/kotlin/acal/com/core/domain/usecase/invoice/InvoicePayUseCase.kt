...
import acal.com.core.domain.enums.FinancialRecordReason.INVOICE_PAYMENT
...
class InvoicePayUseCase(
    ...
    fun execute(id: String) {
        dataSource.findById(id)?.let {
            financial.execute( FinancialRecordCreate(financialRecord = it, reason = INVOICE_PAYMENT) )
